...
import flowchartImg from "@/assets/purification-flowchart.png";
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <ScrollReveal>
            <div className="text-center mb-8">
              <span className="text-xs font-mono uppercase tracking-widest text-primary mb-3 block">📊 Process</span>
              <h2 className="text-3xl md:text-4xl font-extrabold text-foreground mb-2">
                Purification & Refining Process
              </h2>
              <p className="text-muted-foreground max-w-xl mx-auto">
                How different metals go through unique purification pathways to achieve high purity.
              </p>
            </div>
          </ScrollReveal>
          <ScrollReveal delay={100}>
            <div className="rounded-2xl border border-border/30 overflow-hidden bg-card/40 backdrop-blur-xl p-4">
              <img
                src={flowchartImg}
                alt="Purification and Refining Process flowchart showing Gold, Silver, Copper, and Rare Earth Elements recovery paths"
